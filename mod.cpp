...
overview        = "Special Operations Group Official Modification";         // Overview text, displayed from the extension menu
description     = "It's unclear where this will show"; // Probably in context with action
action          = "https://a3sof.org";    // Website URL, that can accessed from the expansions menu 
